## Purpose
Defines the Python subprocess Telegram worker runtime, including startup, session reuse, authorization commands, proxy mapping, events, and sensitive data handling.
