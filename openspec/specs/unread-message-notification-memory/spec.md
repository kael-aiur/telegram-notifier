## Purpose
Defines persistent already-notified Telegram message memory for unread scans, including deduplication keys, notification retry boundaries, and privacy constraints.
